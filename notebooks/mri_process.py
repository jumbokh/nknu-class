...
def kaggle_download(username = "jumbokh", key = "key"):
    api_token = {"username":"jumbokh","key": key}
...
def process():
    # to have Imgae and Mask file/path List
    ...
    return Image_Series, Mask_Series, Main_Data

def show_img_mask(Main_Data):
    # to show data with mask
    count = 0
